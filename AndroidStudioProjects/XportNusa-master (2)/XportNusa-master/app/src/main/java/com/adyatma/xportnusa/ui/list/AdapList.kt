...
class AdapList(context: Context, dataArrayList: ArrayList<DataList>) :
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        customDetailImage.setImageResource(dataList?.Image ?: 0)
        customProdukDetails.text = dataList?.produkDetails
        customProdukDescriptions.text = dataList?.produkDescriptions
